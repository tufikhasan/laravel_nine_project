    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form id="myForm" class="card-body" method="POST" action="{{ route('store.testimonial') }}">
                            @csrf
                            <p class="card-title-desc">Add New Testimonial from here</p>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="feedback" name="feedback" class="form-control" maxlength="225" rows="3"></textarea>
                                </div>
                            </div>
                            <!-- end row -->
