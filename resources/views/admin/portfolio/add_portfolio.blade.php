    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form class="card-body" method="POST" action="{{ route('store.portfolio') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <p class="card-title-desc">Add new portfolio from here</p>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="title_info" name="portfolio_name"
                                        value="{{ old('portfolio_name', $portfolio_name ?? '') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="title" name="portfolio_title"
                                        value="{{ old('portfolio_title', $portfolio_title ?? '') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="portfolio_description">{{ old('portfolio_description', $portfolio_description ?? '') }}</textarea>
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="url" id="portfolio_link" name="portfolio_link"
                                        value="{{ old('portfolio_link', $portfolio_link ?? '') }}">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
