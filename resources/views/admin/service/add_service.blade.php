    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form id="addServiceForm" class="card-body" method="POST" action="{{ route('store.service') }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="description" name="description">{{ old('description', $description ?? '') }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="service_list" name="service_list"
                                        value="{{ old('service_list', $service_list ?? 'User Research & Testing,UX Design,Visual Design,Information Architecture') }}"
                                        data-role="tagsinput">
                                </div>
                            </div>
                            <!-- end row -->
