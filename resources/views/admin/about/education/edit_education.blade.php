                ...
                <div class="col-12">
                    <div class="card">
                        <form id="myForm" class="card-body" method="POST"
                            action="{{ route('update.education', $education->id) }}">
                            @csrf
                            @method('patch')
                            <p class="card-title-desc">Edit Education from here</p>
                            <div class="row mb-3">
                                <label for="date" class="col-sm-2 col-form-label">Education Duration</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="date" name="date"
                                        value="{{ old('date', $education->date ?? '') }}">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="description" name="description" class="form-control" maxlength="225" rows="3"
                                        placeholder="This textarea has a limit of 225 chars.">{{ $education->description }}</textarea>
                                </div>
                            </div>
                            <!-- end row -->
